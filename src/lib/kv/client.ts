...
const url = process.env.KV_REST_API_URL ?? process.env.VERCEL_KV_URL ?? process.env.UPSTASH_REDIS_REST_URL;
const token = process.env.KV_REST_API_TOKEN ?? process.env.VERCEL_KV_TOKEN ?? process.env.UPSTASH_REDIS_REST_TOKEN;
